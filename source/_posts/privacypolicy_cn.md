...
（1）第三方SDK名称：移动安全联盟 SDK

收集个人信息用途/目的：数据分析

收集的个人信息的类型：网络状态、OAID
...
收集个人信息用途/目的：广告聚合服务，聚合多家广告平台进行变现，调整广告投放策略，基于用户设备信息分析广告行为

收集的个人信息的类型：Android ID、OAID、MAC地址、SSID、IP

第三方SDK提供方：广州塔酷信息科技有限公司

第三方隐私权政策链接： https://newdocs.toponad.com/docs/1Mn1B7

（3）第三方SDK名称：穿山甲

收集个人信息用途/目的：广告投放

收集的个人信息的类型：设备信息（IP地址、Android ID、MAC地址）、应用信息、粗略位置信息、Android设备标识符（如IMEI、OAID、IMSI、设备序列号）、设备传感器信息

第三方SDK提供方：北京巨量引擎网络技术有限公司
